...
- Données à disposition : 
  - Stock Sirene 4 (~ 2.5 millions d'observations)
...
- 💡 Idée générale : 
  - Donner les informations les plus pertinentes à un LLM pour qu'il soit capable de recoder les codes NAF 2008 en NAF 2025
...
- Parsing de la réponse :
  - Vérifie que le format est le bon
...
| --- | --- | --- | --- | --- |
| Qwen 2.5 | 32B | [Lent]{.orange} | [Bonnes performances]{.green} | Très restrictif |
...
| Llama 3.1 | 70B (quantisé) | [Extrêmement lent]{.red} | [Très bonnes performances]{.green2} | Assez restrictif |
