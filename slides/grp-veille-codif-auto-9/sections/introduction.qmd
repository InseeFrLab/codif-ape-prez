...
- [**Novembre 2022**]{.orange} : 1ère mise en production d'un modèle ML
- [**Janvier 2023**]{.orange} : Passage de Sirene 3 à 4. Création d'entreprises seulement
- [**Mai 2023**]{.orange} : 1er ré-entrainement pour corriger un problème de classification
- [**Mars 2024**]{.orange} : Toutes les liasses passent par fasttext
- Et maintenant ?
