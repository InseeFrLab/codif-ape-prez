...
::: {.callout-important}
Les performances du modèle Mistral ne sont pour le moment pas comparables.
:::
...
data = {
    ...
    'accuracy': [.8431, .8225, .7371, .6881, .6701,
                 .8984, .8719, .7772, .7064, .6803,
                 .9857, .9838, .9624, .9445, .9356,
                 .8771, .8508, .7627, .7041, .6836,
                 .9170, .8886, .7847, .7350, .7034,
                 .9215, .8969, .8074, .7555, .7355]
}
