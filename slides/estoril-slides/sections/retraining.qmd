...
- Additional specific retraining procedures can be triggered:
  - When the monitoring system detects unusual shifts in data which
  - When repeated claims are made by certain companies on their activity code
  - When coding concepts change

## What training data ?

- When retraining a model from scratch: how far should we go in the past to build the training data set ?
...
![Accuracy and training set size as functions of the earliest year included in historical training data](../img/acc_training_size.png)