...
- ... or use [**pre-trained models**]{.orange} on [Hugging Face](https://huggingface.co/) down the road (when we have GPUs in production...)
:::
...
Using integrated predictions from [**Captum**](https://captum.ai/){.orange}, we can measure feature importance in predictions:

| ![](../img/4332A-word.png){width=90%} | ![](../img/4332A-letter.png){width=90%} |
|--------------------------|--------------------------|
