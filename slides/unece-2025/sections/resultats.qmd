...
## Retraining with NAF 2025

- [**Rebuilt**]{.orange} Sirene 4 with NAF 2025 (~2M records)
- [**Data distribution unchanged**]{.orange}
- New Sirene 4 [**variables used**]{.orange}
- Achieved [**comparable performance**]{.orange} to NAF 2008 model
