## A package from FAIR lab {#section_4_1 .backgroundStandard_violet .smaller}

![](../img/fasttext.png){width=400px fig-align="center"}
...
- Up until November 2022, we used an automatic label coding system, called Sicore
    ...
    + Drawbacks : if the label did not match an encryption example, no code suggestion was returned.
It was then coded manually by a human being
...
## Feature extraction {#section_4_2 .backgroundStandard_violet}
...
## Linear classifer {#section_4_3 .backgroundStandard_violet}
...
## fastText model {#section_4_4 .backgroundStandard_violet background-image="../img/diag-fasttext.png" background-size="95%" background-position="50% 75%"} 

- [**fastText**]{.orange}: very [**simple**]{.blue2} and [**fast**]{.blue2} (`C++`) "bag of n-grams" model.


## Handling categorical variables {#section_4_5 .backgroundStandard_violet}
...
## Preprocessing {#section_4_6a .backgroundStandard_violet}
...
## Preprocessing {#section_4_6b .backgroundStandard_violet}
...
## Preprocessing {#section_4_6c .backgroundStandard_violet}
...
## Modeling {#section_4_7 .backgroundStandard_violet}
