...
::: {#fig-diff-brute layout-nrow=2 float-placement="!tbp"}
![Moyenne des avis bruts au niveau classe](../img/difficulte_brute_niv4.png){#fig-diff-brute-niv4 width=80%}

![Moyenne des avis bruts au niveau sous-classe](../img/difficulte_brute_niv5.png){#fig-diff-brute-niv5 width=80%}
...
Proportion de cas jugés difficiles (avis supérieur à 3/5) en fonction des multivoques
::::
